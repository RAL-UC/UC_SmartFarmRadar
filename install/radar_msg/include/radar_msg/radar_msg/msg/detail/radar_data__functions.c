...
radar_msg__msg__RadarData__init(radar_msg__msg__RadarData * msg)
{
  ...
  // data_real
  if (!rosidl_runtime_c__double__Sequence__init(&msg->data_real, 0)) {
    radar_msg__msg__RadarData__fini(msg);
    return false;
  }
  // data_imag
  if (!rosidl_runtime_c__double__Sequence__init(&msg->data_imag, 0)) {
    radar_msg__msg__RadarData__fini(msg);
    return false;
  }
  return true;
...
radar_msg__msg__RadarData__fini(radar_msg__msg__RadarData * msg)
{
  ...
  // data_real
  rosidl_runtime_c__double__Sequence__fini(&msg->data_real);
  // data_imag
  rosidl_runtime_c__double__Sequence__fini(&msg->data_imag);
}
...
radar_msg__msg__RadarData__are_equal(const radar_msg__msg__RadarData * lhs, const radar_msg__msg__RadarData * rhs)
{
  ...
  if (!rosidl_runtime_c__double__Sequence__are_equal(
      &(lhs->data_real), &(rhs->data_real)))
  {
    return false;
  }
  // data_imag
  if (!rosidl_runtime_c__double__Sequence__are_equal(
      &(lhs->data_imag), &(rhs->data_imag)))
  {
    return false;
  }
  return true;
  ...
  radar_msg__msg__RadarData * output)
{
  ...
  if (!rosidl_runtime_c__double__Sequence__copy(
      &(input->data_real), &(output->data_real)))
  {
    return false;
  }
  // data_imag
  if (!rosidl_runtime_c__double__Sequence__copy(
      &(input->data_imag), &(output->data_imag)))
  {
    return false;
  }
  return true;
