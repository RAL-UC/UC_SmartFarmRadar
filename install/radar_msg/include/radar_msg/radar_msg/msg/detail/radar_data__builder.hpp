...
class Init_RadarData_data_imag
{
public:
  explicit Init_RadarData_data_imag(::radar_msg::msg::RadarData & msg)
  : msg_(msg)
  {}
  ::radar_msg::msg::RadarData data_imag(::radar_msg::msg::RadarData::_data_imag_type arg)
  {
    msg_.data_imag = std::move(arg);
...
class Init_RadarData_data_real
{
public:
  explicit Init_RadarData_data_real(::radar_msg::msg::RadarData & msg)
  : msg_(msg)
  {}
  Init_RadarData_data_imag data_real(::radar_msg::msg::RadarData::_data_real_type arg)
  {
    msg_.data_real = std::move(arg);
    return Init_RadarData_data_imag(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_RadarData_data_real dtype(::radar_msg::msg::RadarData::_dtype_type arg)
  {
    msg_.dtype = std::move(arg);
    return Init_RadarData_data_real(msg_);
  }
