...
struct RadarData_
{
  ...
  _dtype_type dtype;
  using _data_real_type =
    std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>>;
  _data_real_type data_real;
  using _data_imag_type =
    std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>>;
  _data_imag_type data_imag;
  ...
  bool operator==(const RadarData_ & other) const
  {
    ...
    if (this->data_real != other.data_real) {
      return false;
    }
    if (this->data_imag != other.data_imag) {
      return false;
    }
    return true;
  }
