...
class RadarNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('bandwidth',     500e6)    # Hz
        self.declare_parameter('ramp_time_us',  0.5e3)    # μs
        ...
        self.declare_parameter('settle_time',  0.3)       # s

        # Leer parámetros
        p = self.get_parameter
        self.ramp_time_us= p('ramp_time_us').get_parameter_value().double_value
        ...
        self.settle_time = p('settle_time').get_parameter_value().double_value
    ...
    def _do_sweep(self):
        ...
        self.get_logger().info(
            f"Publicado Matrix2D: {msg.rows} {msg.cols}, dtype={msg.dtype}"
        )

        self.get_logger().info('Barrido completo, apagando nodo.')
        rclpy.shutdown()
