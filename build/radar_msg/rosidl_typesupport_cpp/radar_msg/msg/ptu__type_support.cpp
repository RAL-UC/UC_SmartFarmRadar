...
static const _Ptu_type_support_symbol_names_t _Ptu_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, radar_msg, msg, Ptu)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, radar_msg, msg, Ptu)),
  }
};
...
{
  return &::radar_msg::msg::rosidl_typesupport_cpp::Ptu_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, radar_msg, msg, Ptu)() {
  return get_message_type_support_handle<radar_msg::msg::Ptu>();
}
