...
#include "rosidl_runtime_c/primitives_sequence.h"  // data_imag, data_real
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // data_imag, data_real
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: data_real
  {
    size_t size = ros_message->data_real.size;
    auto array_ptr = ros_message->data_real.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }

  // Field name: data_imag
  {
    size_t size = ros_message->data_imag.size;
    auto array_ptr = ros_message->data_imag.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: data_real
  {
    ...
    if (ros_message->data_real.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->data_real);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->data_real, size)) {
      fprintf(stderr, "failed to create array for field 'data_real'");
      return false;
    }
    auto array_ptr = ros_message->data_real.data;
  ...
  // Field name: data_imag
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->data_imag.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->data_imag);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->data_imag, size)) {
      fprintf(stderr, "failed to create array for field 'data_imag'");
      return false;
    }
    auto array_ptr = ros_message->data_imag.data;
    cdr.deserializeArray(array_ptr, size);
  ...
  size_t current_alignment)
{
  ...
  // field.name data_real
  {
    size_t array_size = ros_message->data_real.size;
    auto array_ptr = ros_message->data_real.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
  ...
  // field.name data_imag
  {
    size_t array_size = ros_message->data_imag.size;
    auto array_ptr = ros_message->data_imag.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
